                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <ul style="text-align:left; margin-bottom: 15px; margin-top: 0; color: #000000; font-size: 16px; list-style-type: circle;">
                                        <li><b>{{ $dataArray['req_hd_descs'] }}</b></li>
                                        <li>With a total estimated amount of Rp {{ $dataArray['total_price'] }}</li>
                                        <li>RF no : {{ $dataArray['req_hd_no'] }}</li>
                                    </ul>
                                    ...
                                    <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px;">
                                        In case you need some clarification, kindly approach : {{ $dataArray['user_name'] }}<br>
                                    </p>
