                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="{{ url('/api/'.$module.'/getaccess') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <input type="text" id="trx_date" name="trx_date" value="<?php echo $trx_date?>" hidden>
